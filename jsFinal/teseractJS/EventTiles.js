public class eventTiles{
  ...
  public var activeEventdraw(var id){
    switch(id){
      case 1:
  ...
  public var pActiveEventdraw(var id){
    switch(id){
      case 5:
        return levelButton1;
      case 6:
